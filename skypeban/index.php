                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    <a href="index.php" class="active"><i class="fa fa-home sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Home</span></a>
                                </li>
                        ...
                        <div class="row">
	                        <div class="col-xs-12">
		                        <div class="block">
			                        ...
			                        <h5 style="text-align: center; font-size: 15px; margin-top: -10px;">Welcome to OddMock TEMTPEMTEP, we are the best/only provider for this kind of service. If you want to get rid of someone annoying or that is harassing you? Someone that constantly bullies you on OddMock TEMPTMTEPTEMTP? Well, our services will allow you to sort that problem out! It's a quick, easy and simple process, that should only takes 24-48 hours for the targeted OddMock TMETPMTEPTEMP account to be banned.</h5>

<h5 style="text-align: center; font-size: 15px;">Our website is incredibly easy to navigate and use, it is clean, simple, and online 24/7. We provide live support and ticket support, if you have any questions, problems, or suggestions, simply contact staff! It’s as easy as that. You will be notified via ControlPanel when the OddMock TEMTPETMETPEMTPETMP is banned.</h5>

<h5 style="text-align: center; font-size: 15px;">Thank you for choosing OddMock,</h5>
...
<div class="col-sm-6" align="center">
                            ...
                            <div>
                                <table class="table-condensed">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Website</td>
                                            <td><span class="label label-success">Online</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Panel</td>
                                        ...
                                        <tr>
                                            <td>Collection Monitor Status</td>
                                            <td><span class="label label-success">Online</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Collection Monitoring Status</td>
                                            <td><span class="label label-success">Online</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Checkout System</td>
                                            <td><span class="label label-success">Online</span>
                                            </td>
                                        </tr>
                            ...
                            <img class="img-circle" src="img/nate.png" width="40px" height="40px" align="">
                                <h5><b>Nate</b>
                                <p>Owner - Support</p>
                                </h5>
                                ...
                                <img class="img-circle" src="img/lance.jpg" width="40px" height="40px" align="">
                                <h5><b>Lance</b>
                                <p>Support</p>
                                </h5>
