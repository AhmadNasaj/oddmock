...
class Login {
    ...
    public function __construct($db, $session, $functions, $configs) {
        $this->db = $db;
    ...
    function login($subuser, $subpass, $subremember) {
        ...
        if (!$subuser || strlen($subuser = trim($subuser)) == 0) {
            ...
            if (!preg_match('#^[-\]_+ [a-zA-Z0-9]+$#u', $subuser)) {
    ...
    public function addLoginAttempt($username) {
        ...
        $sql = $this->db->query("UPDATE " . TBL_USERS . " SET user_login_attempts = '$num_of_attempts' WHERE username = '$username'");
    ...
    public function resetLoginAttempts($username) {
        $sql = $this->db->query("UPDATE " . TBL_USERS . " SET user_login_attempts = '0' WHERE username = '$username'");
    }

    public function getLoginAttempts($username) {
        $stmt = $this->db->query("SELECT user_login_attempts FROM " . TBL_USERS . " WHERE username = '$username'");
